...
class Face_Recognition_System:
    ...
    #Automatic Attendance Management System Using Face Detecton 
        title_lbl=Label(bg_img,text="Automatic Attendance Management System Using Face Detecton ",font=("times new roman",24,"bold"),bg="white",fg="red")
